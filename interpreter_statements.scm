...
(define pret-const
  (lambda (name args class instance new-class new-instance)
    (begin (cond
      ((null? (cadddr new-class)) (get-inst-env (cadr (caadr new-class)) '() new-class new-instance (lambda (i) (funcall-helper (cons 'funcall (cons name args)) (get-const class args) (new-env) class instance new-class i (error "ret") (error "brk") (error "cont") (error "throw")))))
